...
public class GetSteps {
  ...
  public void the_get_system_request_is_sent_for_code_with_an_empty_jwt(String code)
      throws Exception {
  ...
  public void the_get_system_request_is_sent_for_code_with_no_authorisation_header(String code)
      throws Exception {
