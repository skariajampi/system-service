...
public class RequestDelegate {
  ...
  public MockHttpServletResponse getSystem(String code, String jwt) throws Exception {
  ...
  public MockHttpServletResponse getSystemNoAuth(String code) throws Exception {

    return mockMvc.perform(get(SYSTEMS_WITH_CODE, code)).andDo(print()).andReturn().getResponse();
  }

  public MockHttpServletResponse deleteSystemNoAuth(String code) throws Exception {
    return mockMvc.perform(delete(SYSTEMS_WITH_CODE, code)).andReturn().getResponse();
  }

  public MockHttpServletResponse deleteSystem(String code, String jwt) throws Exception {
    return mockMvc
  ...
  public MockHttpServletResponse putSystemNoAuth(String code, CreateUpdateSystemRequest request)
      throws Exception {
  ...
  public MockHttpServletResponse getManagement(String endpoint) throws Exception {

    return mockMvc.perform(get(endpoint)).andDo(print()).andReturn().getResponse();
  }
}
