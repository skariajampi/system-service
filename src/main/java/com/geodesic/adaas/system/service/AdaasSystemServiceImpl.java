...
public class AdaasSystemServiceImpl implements AdaasSystemService {
  ...
  @Override
  public SystemResponse update(String code, CreateUpdateSystemRequest createUpdateSystemRequest)
  ...
  public SystemResponse getAdaasSystem(String code) throws RecordNotFoundException {
    ...
    return optionalSystemEntity
        .map(this::createResponse)
        .orElseThrow(() -> new RecordNotFoundException(code + " not found"));
  }
